...
title HomeoCare AI - Download Offline Packages
...
echo.
echo  ================================================================
echo   HomeoCare AI  -  OFFLINE PACKAGE DOWNLOADER
echo  ================================================================
echo.
...
if "%PIP%"=="" (echo   [FAIL]  pip not found. Run START_HomeoCare_AI.bat first. & pause & exit /b 1)
...
echo.
echo  ================================================================
echo   DONE. HomeoCare AI now works WITHOUT internet connection.
echo   Run START_HomeoCare_AI.bat to launch.
echo  ================================================================
echo.
pause
